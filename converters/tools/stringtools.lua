...
---
--- Replaces the character at a certain position in a `string`.
---
--- @param self     string   The string to replace a character in.
--- @param pos      integer  The position of the character to replace.
--- @param replace  string   The character to replace it with.
---
--- @return string
---
function string.replaceChar(self, pos, replace)
    return self:sub(1, pos - 1) .. replace .. self:sub(pos + 1)
end
